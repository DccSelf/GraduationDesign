...
static void init_array (int ni, int nj,DATA_TYPE POLYBENCH_2D(A,NI,NJ,ni,nj))
{
  int i, j;
...
static void kernel_conv2d(int ni,int nj,DATA_TYPE POLYBENCH_2D(A,NI,NJ,ni,nj),DATA_TYPE POLYBENCH_2D(B,NI,NJ,ni,nj))
{
  int i, j;
  #pragma scop
